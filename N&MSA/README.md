Sentiment and Emotion Analysis of Reddit WallStreetBets Posts on GME Using NLP 
...
General-purpose language models have limitations when applied to domain-specific text
Model results must always be interpreted in the context of the data and domain

This project highlights my ability to work in a structured, end-to-end manner with NLP, understand model limitations, and translate analysis into meaningful insights.
